...
<fieldset>
  ...
  <table class="display table t-table">
   ...
   <tr>  
     <td>
       <textarea name="tr_115" class="form-control"><?php echo $translation['tr_115']; ?></textarea>
     </td>
   </tr>
   ...
   <tr>  
     <td>
       <textarea name="tr_118" class="form-control"><?php echo $translation['tr_118']; ?></textarea>
     </td>
   </tr>
   ...
   <tr>  
     <td>
       <textarea name="tr_119" class="form-control"><?php echo $translation['tr_119']; ?></textarea>
     </td>
   </tr>
