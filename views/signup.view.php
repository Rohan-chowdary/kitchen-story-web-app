...
<button class="g-recaptcha uk-button uk-button uk-width-1-1 uk-border-pill" type="submit"  data-callback="onRecaptchaSuccess"><?php echo echoOutput($translation['tr_150']); ?></button>
