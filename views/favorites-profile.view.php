<h4 class="uk-heading-line"><span><?php echo echoOutput($translation['tr_182']); ?></span></h4>
...
$(document).ready(function(){
    ...
    'searchable': false,
    "mRender" : function (data) {
      return '<a class="deleteItem" data-item="'+data.recipe_id+'" data-user="<?php echo $userInfo['user_id']; ?>"><span class="uk-label uk-label-danger uk-text-danger"><?php echo $translation['tr_112']; ?></span></a>';}
    }
    ]
  });
  });
