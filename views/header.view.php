...
<?php if(!empty($itemDetails['recipe_image'])): ?>
<meta property="og:image" content="<?php echo $urlPath->image($itemDetails['recipe_image']); ?>" />
<?php endif; ?>
<?php endif; ?>
<?php endif; ?>
...
<script src="<?php echo $urlPath->assets_js('lity.min.js'); ?>"></script>
